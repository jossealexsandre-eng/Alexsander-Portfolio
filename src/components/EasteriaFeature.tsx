    ...
    <section id="easteria-story" className="py-24 md:py-36 bg-[#F2F1ED] border-b border-[#DDDDD8]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="max-w-4xl mb-16 md:mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-[#111111] tracking-tight uppercase mb-6">
            Building Easteria
          </h2>
          ...
          {/* Quick Action Links: Instagram & Google Maps */}
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <a
              href="https://instagram.com/hello.easteria"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#111111] hover:bg-[#0F4C81] text-white text-xs font-mono tracking-wider uppercase transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-white hover:bg-[#E8E8E4] text-[#111111] border border-[#DDDDD8] text-xs font-mono tracking-wider uppercase transition-colors"
            >
        ...
        {/* Visual Showcase: Real Storefront & Official Logo */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-20 items-stretch">
          {/* Main Storefront Visual Card */}
          <div className="lg:col-span-7 relative overflow-hidden border border-[#DDDDD8] bg-[#E8E8E4] flex flex-col group min-h-[420px]">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="border border-[#DDDDD8] bg-[#F7F7F5] p-6 sm:p-8 flex flex-col items-center justify-center text-center relative overflow-hidden group">
            ...
            <div className="border border-[#DDDDD8] bg-white p-6 flex-1 flex flex-col justify-between space-y-4">
              <div>
