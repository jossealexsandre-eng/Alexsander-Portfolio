    ...
    <>
      <header
        ...
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
          scrolled
            ? 'bg-[#F7F7F5]/92 backdrop-blur-md py-3.5 md:py-4 border-b border-[#DDDDD8] shadow-xs'
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          >
            <span className="text-sm md:text-base font-extrabold tracking-[0.2em] text-[#111111] group-hover:text-[#0F4C81] transition-colors duration-300">
              {PERSONAL_INFO.name}
            </span>
          ...
          {/* Desktop Links with Left-to-Right Underline Animation */}
          <nav id="desktop-nav-menu" className="hidden md:flex items-center space-x-7 lg:space-x-9">
            {navLinks.map((link) => (
              <a
                ...
                className="text-xs font-semibold tracking-[0.18em] text-[#111111] hover:text-[#0F4C81] transition-colors relative py-1 group/link"
              >
                <span>{link.label}</span>
                {/* Thin underline animation from left to right */}
                <span className="absolute bottom-0 left-0 w-full h-[1px] bg-[#0F4C81] scale-x-0 origin-left transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover/link:scale-x-100" />
              </a>
            ))}
            ...
            >
              <div className="inline-flex items-center space-x-1.5 text-xs font-bold tracking-[0.18em] text-[#0F4C81] hover:text-[#111111] border border-[#0F4C81]/30 hover:border-[#111111] px-4 py-2 transition-all duration-300 rounded-none group bg-white/40 hover:bg-white shadow-2xs">
      ...
      {/* Fullscreen Mobile Navigation Drawer with Smooth AnimatePresence */}
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-50 bg-[#F7F7F5] flex flex-col justify-between p-8 md:hidden text-[#111111]"
          >
